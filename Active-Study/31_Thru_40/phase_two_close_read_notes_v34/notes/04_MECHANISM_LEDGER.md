...
## Pass 39 — Ancient Yi readout mechanism

```text
retained trigram/hexagram line carrier
-> fixed line-order convention
-> binary positional expansion
-> octal positional expansion
-> decimal scalar readout
```

Orthad mapping: readout transformation is boundary/projection behavior; the retained carrier is prior to the number.


## Ancient Yi carry/lift mechanism
Retained line-symbol carrier -> octal place-value readout -> fixed-domain cycle completion at 8^k-1 -> lifted place domain. Strong operational bridge for Q/support, L/lift, Orthad custody/readout; B/refinement remains an operational successor/carry candidate pending exact rule extraction.
