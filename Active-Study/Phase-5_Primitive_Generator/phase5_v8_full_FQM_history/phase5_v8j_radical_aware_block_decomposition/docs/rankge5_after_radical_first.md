# Phase 5 v8j: Radical-Aware Block Decomposition
...
- Ground-truth validation: 229/229 decomposed.
- Nondegenerate rows: 138.
- Degenerate rows: 91.
- Non-summand radicals detected: 0 in the ground-truth range.
- Rank>=5 corrected residual cores: 5/5 decomposed to block symbols.
...
See outputs/phase5_v8j_rankge5_radical_first_decomposition.csv.