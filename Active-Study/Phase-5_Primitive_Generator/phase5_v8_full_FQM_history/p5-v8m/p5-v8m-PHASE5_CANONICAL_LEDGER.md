...
- v8h archival rank-4 closure — retro-check RUN in v8k (true diagonals [1,3,3,5], archival lands
  class 6 of a new true-diagonal table); remains PROVISIONALLY closed pending publication of that
  table + decision certificates in v8l. Pinned-diagonal orbit table itself unaffected and stands.
  [v8k; audit 07-09]
...
no search verbs in any code path; success = (12|n) survives one B->floor->L crossing). v8l
(true-diagonal table + 229/229 + five cores, META_VERIFIER layer) lands after. Physical arm
unchanged.
