...
## v53 — Wilhelm line-event automata mechanism

| Mechanism | Finding | Bridge status |
|---|---|---|
| Retained six-line carrier | Required for transition graph; ordinal/name/text is insufficient | STRONG |
| Selected line event | Six event choices over each carrier yield 384 emitted line readings | STRONG |
| Semantic readout | Category flags classify emitted line judgments, not the carried state | PROJECTION-LOSS GATE |
| Line-position ladder | Position changes operational meaning; line 3 and line 6 mark different boundary functions | STRONG EXTERNAL BRIDGE |


## v54 mechanism lock — state-completeness kernel

A projection/readout/scalar label is bridge-admissible only when it preserves enough retained state to determine the next admissible transition under the relevant operator family. This is now the common gate across Orthad, CF19, Ancient Yi, Wilhelm, Pencil/Yin-Yang, MFE/Liu, monodromy, branch grammar, NC geometry, TDAHE, and Domesticating Chaos.


## v55 mechanism lock — available-source boundary

| Mechanism | Status | Bridge use |
|---|---:|---|
| Available-source terminality | NEAR-TERMINAL | Current corpus is exhausted enough for bridge research, but not final proof. |
| Hard blocker separation | STRONG_METHOD_GATE | Prevents cosmetic 100% claims and protects source/data honesty. |
| Claim readiness ladder | ACTIVE | Separates locked claims, strong bridges, open candidates, and forbidden overreach. |
| Modular-B path | OPEN | Preserved as carrier/domain-selected refinement arithmetic; not collapsed into one sequence. |
