...
Added `notes/10_CLOSE_READ_PASS4_PROSPECTING.md`.

The dossier is now explicitly in research-prospecting mode. Selector-complete macro calculus is quarantined as stale/wrong until checked against the latest external-HDD Phase Calculus source.

Highest-priority next research lead: `Dongyuan jiurong` / circle + nine right triangles as possible external B-depth analogue.
